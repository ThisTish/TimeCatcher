	...
	return (
		...
		<div className={cn(
			...
			currentDigit === 'AM' || currentDigit === 'PM'
				? 'w-16 sm:32 md:w-48' : 'w-10 sm:w-16 md:w-24',
			...
			<div className=" relative w-full h-1/2 bg-slate-300 rounded-t-md overflow-hidden shadow-md ">
				<p className="absolute top-1 left-2  md:top-4 md:left-2 tabular-nums">
					{currentDigit}
				</p>
			</div>
			...
			<div className=" relative w-full h-1/2 bg-slate-200 rounded-b-md overflow-hidden shadow-md">
				<p className="absolute -top-5 left-2 md:-top-14 md:left-2  tabular-nums">
					{prevDigit}
				</p>
			</div>
			...
			{/* {isFlipped ? null : (
				...
				<div
					...
					<div
						className={`animate-flip-down bg-slate-300 w-full h-1/2 transform origin-bottom`}>
						<p className=" absolute top-1 left-2 md:top-4 md:left-2 tabular-nums">
							{prevDigit}
						</p>
					</div>
